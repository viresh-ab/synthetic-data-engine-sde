...
#     .stApp {
#         background-image:
#             linear-gradient(120deg, rgba(5, 8, 20, 0.85) 0%, rgba(10, 18, 34, 0.82) 45%, rgba(24, 12, 45, 0.82) 100%),
...
#     [data-testid="stDateInput"] label, [data-testid="stCheckbox"] label,
#     [data-testid="stRadio"] label, [data-testid="stSlider"] label {
#         color: #e7edff !important;
#     }
#     .stButton > button {
#         color: #f4f8ff !important;
#         background: linear-gradient(135deg, rgba(70, 96, 170, 0.85), rgba(92, 63, 175, 0.86));
#         border: 1px solid rgba(179, 198, 255, 0.45);
#         border-radius: 10px;
#     }
#     .stButton > button:hover {
#         border-color: rgba(207, 220, 255, 0.8);
#         box-shadow: 0 8px 24px rgba(30, 43, 80, 0.45);
#     }
#     .block-container {
#         padding-top: 1.5rem;
#         padding-bottom: 2rem;
...
#     }
#     .hero-panel {
#         background: linear-gradient(135deg, rgba(18, 28, 56, 0.78), rgba(43, 23, 76, 0.70));
#         border: 1px solid rgba(160, 186, 255, 0.25);
#         border-radius: 18px;
#         padding: 1.4rem 1.6rem;
#         margin-bottom: 1rem;
#         box-shadow: 0 16px 44px rgba(0, 0, 0, 0.40);
#         backdrop-filter: blur(8px);
#         animation: fadeIn 0.95s ease-out;
#     }
#     .feature-card {
#         background: rgba(18, 27, 49, 0.72);
#         border: 1px solid rgba(145, 170, 244, 0.22);
#         border-radius: 14px;
#         padding: 1rem;
#         min-height: 215px;
...
#         border-color: rgba(173, 199, 255, 0.6);
#         box-shadow: 0 16px 34px rgba(0, 0, 0, 0.42);
#     }
#     .glass-box {
#         background: rgba(12, 18, 38, 0.74);
#         border: 1px solid rgba(147, 174, 247, 0.23);
#         border-radius: 14px;
#         padding: 1rem 1.2rem;
#         margin-top: 0.8rem;
...
#         border: 1px solid rgba(139, 168, 243, 0.22);
#         color: #e8edff;
#         padding: 1rem;
#         border-radius: 12px;
#         margin-bottom: 1rem;
#     }
#     .success-box {
#         background: rgba(47, 120, 78, 0.22);
#         border: 1px solid rgba(93, 220, 140, 0.45);
#         color: #c7f8d9;
#         padding: 1rem;
...
#     }
#     .warning-box {
#         background: rgba(135, 109, 15, 0.22);
#         border: 1px solid rgba(246, 214, 93, 0.45);
#         color: #ffefbc;
#         padding: 1rem;
#         border-radius: 0.5rem;
#         margin: 1rem 0;
#     }
#     .error-box {
#         background: rgba(133, 35, 53, 0.22);
#         border: 1px solid rgba(255, 128, 152, 0.45);
#         color: #ffd2dc;
#         padding: 1rem;
#         border-radius: 0.5rem;
#         margin: 1rem 0;
...
def page_home():
    ...
    st.markdown(
        ...
        <div class="hero-panel">
            <h3 style="margin:0 0 0.4rem 0;">Create production-ready synthetic datasets in minutes</h3>
            <p style="margin:0; font-size:1.02rem;">
                Generate realistic, privacy-safe synthetic data with intelligent schema detection,
                region-aware PII generation, validation reports, and one-click export.
            </p>
        </div>
        ''',
        unsafe_allow_html=True,
    ...
    with col1:
        ...
        <div class="feature-card">
            ...
            <ul>
                <li>Numeric with correlations</li>
                <li>LLM-powered text fields</li>
                <li>Locale-aware PII records</li>
                <li>Temporal and categorical patterns</li>
                <li>Domain-guided synthesis</li>
            </ul>
        </div>
        ''', unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="feature-card">
            ...
            <ul>
                ...
                <li>Pattern consistency scoring</li>
    ...
    with col3:
        ...
        <div class="feature-card">
            ...
            <ul>
                <li>K-anonymity analysis</li>
                <li>Re-identification risk checks</li>
                <li>Uniqueness and leakage scans</li>
                <li>Sensitive-field diagnostics</li>
                <li>Actionable privacy recommendations</li>
            </ul>
        </div>
        ''', unsafe_allow_html=True)
    ...
    st.markdown(
        '''
        <div class="glass-box">
            <ol style="margin:0.2rem 0 0 1rem;">
                <li><b>Upload</b> your reference data (CSV, Excel, or JSON).</li>
                <li><b>Configure</b> generation options and model settings.</li>
                <li><b>Generate</b> synthetic records instantly.</li>
                <li><b>Validate</b> quality and privacy metrics.</li>
                <li><b>Export</b> your output for analytics/testing.</li>
            </ol>
        </div>
        ''',
        unsafe_allow_html=True,
